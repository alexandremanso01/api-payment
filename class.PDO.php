...
class Database
{
    ...
    private function __construct()
    {
        ...
        $db_nome = $_ENV['DATABASE_NAME'];
        $db_usuario = $_ENV['DATABASE_USER'];
        $db_senha = $_ENV['DATABASE_PASSWORD'];
        $db_driver = $_ENV['DATABASE_DRIVER'];

        # Informações sobre o sistema:
        $system_title = $_ENV['SYSTEM_TITLE'];
        ...
        catch (PDOException $e)
        {
            ...
            mail($system_email, "PDOException em $system_title", $e->getMessage());
